...
exports.userInsights = (0, sqlite_core_1.sqliteTable)("user_insights", {
    userId: (0, sqlite_core_1.text)("user_id").primaryKey(), // References userProfiles.userId (logical)
...
exports.chatMessages = (0, sqlite_core_1.sqliteTable)("chat_messages", {
    id: (0, sqlite_core_1.text)("id").primaryKey().$defaultFn(() => uuid()),
    userId: (0, sqlite_core_1.text)("user_id"), // Twitch user ID (may be null for anonymous)
    username: (0, sqlite_core_1.text)("username").notNull(),
    message: (0, sqlite_core_1.text)("message").notNull(),
    channel: (0, sqlite_core_1.text)("channel").notNull(),
    streamId: (0, sqlite_core_1.text)("stream_id"), // Unique per streaming session
    eventType: (0, sqlite_core_1.text)("event_type").notNull().default("chat"), // chat, redeem, raid, sub, etc.
    ...
    metadata: (0, sqlite_core_1.text)("metadata", { mode: "json" }), // Additional event-specific data
});
/* ================================
   AI Analysis
================================ */
exports.aiAnalysis = (0, sqlite_core_1.sqliteTable)("ai_analysis", {
    ...
    sentiment: (0, sqlite_core_1.text)("sentiment").notNull(), // positive, neutral, negative
    sentimentScore: (0, sqlite_core_1.integer)("sentiment_score").notNull(), // 1-5
    ...
    primaryEmotion: (0, sqlite_core_1.text)("primary_emotion"), // Main emotion
    emotionIntensity: (0, sqlite_core_1.integer)("emotion_intensity").default(5), // 1-10 scale
    // Intent Detection
    intent: (0, sqlite_core_1.text)("intent"), // joking, asking_question, etc.
    intentConfidence: (0, sqlite_core_1.integer)("intent_confidence").default(5), // 1-10
...
exports.aiCommands = (0, sqlite_core_1.sqliteTable)("ai_commands", {
    ...
    responseType: (0, sqlite_core_1.text)("response_type").notNull(), // direct, analysis, generate
...
exports.voiceAiResponses = (0, sqlite_core_1.sqliteTable)("voice_ai_responses", {
    id: (0, sqlite_core_1.text)("id").primaryKey().$defaultFn(() => uuid()),
    originalText: (0, sqlite_core_1.text)("original_text").notNull(), // Raw voice transcription
    rephrasedText: (0, sqlite_core_1.text)("rephrased_text").notNull(), // AI-rephrased version
    wasSpoken: (0, sqlite_core_1.integer)("was_spoken", { mode: "boolean" }).notNull().default(false), // Was it sent to TTS
    timestamp: (0, sqlite_core_1.integer)("timestamp", { mode: "timestamp" }).notNull().$defaultFn(() => new Date()),
});
/* ================================
...
exports.raids = (0, sqlite_core_1.sqliteTable)("raids", {
    id: (0, sqlite_core_1.text)("id").primaryKey().$defaultFn(() => uuid()),
    fromUserId: (0, sqlite_core_1.text)("from_user_id").notNull(), // Raider's Twitch user ID
    fromUsername: (0, sqlite_core_1.text)("from_username").notNull(), // Raider's username
    fromDisplayName: (0, sqlite_core_1.text)("from_display_name").notNull(), // Raider's display name
    viewers: (0, sqlite_core_1.integer)("viewers").notNull().default(0), // Number of viewers in raid
    timestamp: (0, sqlite_core_1.integer)("timestamp", { mode: "timestamp" }).notNull().$defaultFn(() => new Date()),
});
/* ================================
   Moderation Actions
...
exports.moderationActions = (0, sqlite_core_1.sqliteTable)("moderation_actions", {
    id: (0, sqlite_core_1.text)("id").primaryKey().$defaultFn(() => uuid()),
    actionType: (0, sqlite_core_1.text)("action_type").notNull(), // timeout, ban, delete, clear
    targetUserId: (0, sqlite_core_1.text)("target_user_id"), // User being moderated
    targetUsername: (0, sqlite_core_1.text)("target_username").notNull(), // Username of moderated user
    moderatorId: (0, sqlite_core_1.text)("moderator_id"), // Moderator's user ID
    moderatorUsername: (0, sqlite_core_1.text)("moderator_username"), // Moderator's username
    duration: (0, sqlite_core_1.integer)("duration"), // Timeout duration in seconds (null for ban/delete)
    reason: (0, sqlite_core_1.text)("reason"), // Reason for action
    messageDeleted: (0, sqlite_core_1.text)("message_deleted"), // Message text if deleted
    timestamp: (0, sqlite_core_1.integer)("timestamp", { mode: "timestamp" }).notNull().$defaultFn(() => new Date()),
});
/* ================================
...
exports.settings = (0, sqlite_core_1.sqliteTable)("settings", {
    ...
    sentimentThreshold: (0, sqlite_core_1.integer)("sentiment_threshold").notNull().default(2), // 1-5
    ...
    browserSourceToken: (0, sqlite_core_1.text)("browser_source_token"), // Unique token for OBS URL
    // DachiPool Settings
    ...
    dachipoolEnergy: (0, sqlite_core_1.text)("dachipool_energy").notNull().default("Balanced"), // Balanced, High, Low
    dachipoolMode: (0, sqlite_core_1.text)("dachipool_mode").notNull().default("Auto"), // Auto, Manual
    ...
    dachipoolAiTemp: (0, sqlite_core_1.integer)("dachipool_ai_temp").notNull().default(7), // store 0-10
    ...
    // Audio Settings
    audioMicMode: (0, sqlite_core_1.text)("audio_mic_mode").notNull().default("muted"), // muted, passthrough
    ...
    audioCooldownBetweenReplies: (0, sqlite_core_1.integer)("audio_cooldown_between_replies").notNull().default(5), // seconds
    audioMaxVoiceLength: (0, sqlite_core_1.integer)("audio_max_voice_length").notNull().default(500), // characters
    // Web Speech API TTS Settings
    ttsEnabled: (0, sqlite_core_1.integer)("tts_enabled", { mode: "boolean" }).notNull().default(false),
    ttsVoice: (0, sqlite_core_1.text)("tts_voice"), // Voice name
    ttsPitch: (0, sqlite_core_1.integer)("tts_pitch").notNull().default(10), // 5-20 (0.5-2.0), divide by 10
    ttsRate: (0, sqlite_core_1.integer)("tts_rate").notNull().default(10), // 5-20 (0.5-2.0), divide by 10
    ttsVolume: (0, sqlite_core_1.integer)("tts_volume").notNull().default(10), // 0-10 (0.0-1.0), divide by 10
    // Voice AI Personality Settings
    voiceAiPersonality: (0, sqlite_core_1.text)("voice_ai_personality").notNull().default("Neutral"), // Neutral, Quirky, Funny, etc.
    voiceAiPitch: (0, sqlite_core_1.integer)("voice_ai_pitch").notNull().default(10), // 5-20
    voiceAiSpeed: (0, sqlite_core_1.integer)("voice_ai_speed").notNull().default(10), // 5-20
    // Topic Filters
    ...
    dachiastreamCycleInterval: (0, sqlite_core_1.integer)("dachiastream_cycle_interval").notNull().default(15), // seconds between cycles (5-60)
    // Dashboard Settings
...
exports.followerEvents = (0, sqlite_core_1.sqliteTable)("follower_events", {
    ...
    username: (0, sqlite_core_1.text)("username").notNull(),
    eventType: (0, sqlite_core_1.text)("event_type").notNull(), // follow, unfollow, subscribe, etc.
    timestamp: (0, sqlite_core_1.integer)("timestamp", { mode: "timestamp" }).notNull().$defaultFn(() => new Date()),
    // Event-specific data
    ...
    followedAt: (0, sqlite_core_1.integer)("followed_at", { mode: "timestamp" }), // When first followed
